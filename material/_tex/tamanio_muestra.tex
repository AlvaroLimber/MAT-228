...
%\usepackage{iadb}
\usepackage{authblk}
\title{{\Large \textbf{Consideraciones para el Tamaño de Muestra\\ Trabajo Social}}}
...
%\maketitle
\begin{flushright}
\textbf{Docente: Alvaro Chirino Gutierrez, Estadística Social. I-2021}
\end{flushright}
\section{Formula General para el tamaño de  muestra}
\begin{equation}
...
\end{equation}
\item Indicadores de tipo proporción ($P$)
\begin{equation}
